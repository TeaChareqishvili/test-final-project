      ...
      {test ? (
        <>
          <div className="quiz" ref={quizRef}>
            ...
            <label
              style={{
                color: checkAnswer(test.results[0].incorrect_answers[0]),
              }}
            >
              <input
                type="radio"
            ...
            <label
              style={{
                color: checkAnswer(test.results[0].incorrect_answers[1]),
              }}
            >
              <input
                type="radio"
            ...
            <label
              style={{
                color: checkAnswer(test.results[0].incorrect_answers[2]),
              }}
            >
              <input
                type="radio"
            ...
            <label
              style={{ color: checkAnswer(test.results[0].correct_answer) }}
            >
              <input
                type="radio"
                name="god"
